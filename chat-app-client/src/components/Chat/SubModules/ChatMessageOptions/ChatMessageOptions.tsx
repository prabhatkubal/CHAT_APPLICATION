...
const ChatMessageOptions: React.FC<ChatMessageOptionsProps> = ({
  ...
  return (
    <ContextMenu style={{ top: position.top, left: position.left }}>
      <ContextMenuItem onClick={onCopyText}>Copy Text</ContextMenuItem>
      <ContextMenuItem onClick={onDelete}>Delete Message</ContextMenuItem>
