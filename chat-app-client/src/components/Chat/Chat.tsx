...
import ChatWindow from "./SubModules/ChatWindow";
...
export default function Chat() {
  ...
  const selectedRecipientid =
    typeof window !== "undefined"
      ? localStorage.getItem("selectedrecipientid")
      : null;
  ...
  return (
    <ChatLayout
      ...
      sidebarContent={
        <ChatList onlineUsers={onlineUsers} getRecipient={getRecipient} />
      }
      chatContent={<ChatWindow onlineUsers={onlineUsers} messages={messages} emitMessage={emitMessage} />}
    />
  );
}
